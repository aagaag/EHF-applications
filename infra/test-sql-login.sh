...
for migration_file in 001_database_contract.sql 002_application_core.sql 003_audit_and_preferences.sql 004_audit_and_preference_hardening.sql 005_application_permissions.sql 006_user_preference_read.sql 007_document_store.sql 008_import_provenance.sql 009_document_permissions.sql 010_report_export_audit.sql 011_applicant_access.sql 012_applicant_drafts.sql 013_applicant_confirmations.sql 014_applicant_projection.sql 015_applicant_document_slots.sql 016_entra_applicant_workflow.sql 017_applicant_form_simplification.sql; do
