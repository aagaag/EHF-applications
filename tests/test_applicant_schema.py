...
def test_isolated_database_harness_applies_and_validates_release_thirty() -> None:
    ...
    assert "COUNT_BIG(*) FROM dbo.SchemaMigration) <> 30" in contract
    assert "WHERE MigrationCount = 30 AND CurrentVersion = 30" in contract
