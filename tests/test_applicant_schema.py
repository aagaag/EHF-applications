...
def test_isolated_database_harness_applies_and_validates_release_eighteen() -> None:
    ...
    assert "COUNT_BIG(*) FROM dbo.SchemaMigration) <> 18" in contract
    assert "WHERE MigrationCount = 18 AND CurrentVersion = 18" in contract
