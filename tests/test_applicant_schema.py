...
def test_isolated_database_harness_applies_and_validates_release_twenty() -> None:
    ...
    assert "COUNT_BIG(*) FROM dbo.SchemaMigration) <> 20" in contract
    assert "WHERE MigrationCount = 20 AND CurrentVersion = 20" in contract
