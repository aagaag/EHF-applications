...
def test_isolated_database_harness_applies_and_validates_release_fifteen() -> None:
    ...
    assert "COUNT_BIG(*) FROM dbo.SchemaMigration) <> 15" in contract
    assert "WHERE MigrationCount = 15 AND CurrentVersion = 15" in contract
