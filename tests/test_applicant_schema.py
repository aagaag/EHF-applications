...
def test_isolated_database_harness_applies_and_validates_release_seventeen() -> None:
    ...
    assert "COUNT_BIG(*) FROM dbo.SchemaMigration) <> 17" in contract
    assert "WHERE MigrationCount = 17 AND CurrentVersion = 17" in contract
