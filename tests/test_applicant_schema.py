...
def test_isolated_database_harness_applies_and_validates_release_sixteen() -> None:
    ...
    assert "COUNT_BIG(*) FROM dbo.SchemaMigration) <> 16" in contract
    assert "WHERE MigrationCount = 16 AND CurrentVersion = 16" in contract
