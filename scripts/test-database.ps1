...
try {
    ...
    if (($firstRun -join "`n") -notmatch 'Applied 36 migration\(s\)\.') {
        throw 'The first migration run did not apply exactly thirty-six migrations.'
    }
