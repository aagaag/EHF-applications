...
try {
    ...
    if (($firstRun -join "`n") -notmatch 'Applied 38 migration\(s\)\.') {
        throw 'The first migration run did not apply exactly thirty-eight migrations.'
    }
