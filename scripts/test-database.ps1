...
try {
    ...
    if (($firstRun -join "`n") -notmatch 'Applied 39 migration\(s\)\.') {
        throw 'The first migration run did not apply exactly thirty-nine migrations.'
    }
