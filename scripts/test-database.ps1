...
try {
    ...
    if (($firstRun -join "`n") -notmatch 'Applied 35 migration\(s\)\.') {
        throw 'The first migration run did not apply exactly thirty-five migrations.'
    }
