...
try {
    ...
    if (($firstRun -join "`n") -notmatch 'Applied 41 migration\(s\)\.') {
        throw 'The first migration run did not apply exactly forty-one migrations.'
    }
