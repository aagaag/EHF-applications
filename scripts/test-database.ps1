...
try {
    ...
    if (($firstRun -join "`n") -notmatch 'Applied 47 migration\(s\)\.') {
        throw 'The first migration run did not apply exactly forty-seven migrations.'
    }
