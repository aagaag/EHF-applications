...
try {
    ...
    if (($firstRun -join "`n") -notmatch 'Applied 18 migration\(s\)\.') {
        throw 'The first migration run did not apply exactly eighteen migrations.'
    }
