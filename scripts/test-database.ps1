...
try {
    ...
    if (($firstRun -join "`n") -notmatch 'Applied 22 migration\(s\)\.') {
        throw 'The first migration run did not apply exactly twenty-two migrations.'
    }
