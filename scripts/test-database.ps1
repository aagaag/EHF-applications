...
try {
    ...
    if (($firstRun -join "`n") -notmatch 'Applied 37 migration\(s\)\.') {
        throw 'The first migration run did not apply exactly thirty-seven migrations.'
    }
