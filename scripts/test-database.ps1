...
try {
    ...
    if (($firstRun -join "`n") -notmatch 'Applied 25 migration\(s\)\.') {
        throw 'The first migration run did not apply exactly twenty-five migrations.'
    }
