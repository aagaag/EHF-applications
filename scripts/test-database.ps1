...
try {
    ...
    if (($firstRun -join "`n") -notmatch 'Applied 23 migration\(s\)\.') {
        throw 'The first migration run did not apply exactly twenty-three migrations.'
    }
