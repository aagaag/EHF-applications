...
try {
    ...
    if (($firstRun -join "`n") -notmatch 'Applied 40 migration\(s\)\.') {
        throw 'The first migration run did not apply exactly forty migrations.'
    }
