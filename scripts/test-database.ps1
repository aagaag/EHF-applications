...
try {
    ...
    if (($firstRun -join "`n") -notmatch 'Applied 30 migration\(s\)\.') {
        throw 'The first migration run did not apply exactly thirty migrations.'
    }
