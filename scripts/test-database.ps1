...
'001_validate_database_contract.sql,002_validate_application_core.sql,003_validate_audit_and_preferences.sql,004_validate_audit_and_preference_hardening.sql,005_validate_application_permissions.sql,006_validate_user_preference_read.sql,007_validate_document_store.sql,008_validate_import_provenance.sql,009_validate_document_permissions.sql,010_validate_report_export_audit.sql,011_validate_applicant_access.sql,012_validate_applicant_drafts.sql,013_validate_applicant_confirmations.sql,014_validate_applicant_projection.sql,015_validate_applicant_document_slots.sql,016_validate_entra_applicant_workflow.sql,017_validate_applicant_form_simplification.sql,018_validate_applicant_admin_preview.sql,019_validate_synthetic_applicant_workspace.sql,020_validate_synthetic_metrics_academic_age.sql,021_validate_application_publications.sql,022_validate_applicant_publication_preview.sql,023_validate_open_citation_sources.sql,024_validate_applicant_citation_profiles.sql,025_validate_publication_review_workflow.sql,026_validate_internal_document_access.sql,027_validate_internal_document_audit_payload.sql,028_validate_openalex_work_cutoff_metrics.sql,029_validate_openalex_missing_observation_guard.sql,030_validate_applicant_detail_author_roles.sql,031_validate_citation_metric_cutoff_runs.sql,032_validate_cutoff_activation_permissions.sql,033_validate_internal_review_artifacts.sql,034_validate_applicant_journal_metrics.sql,035_validate_imported_application_bundle.sql,036_validate_verified_h_index_metrics.sql,037_validate_trustee_shortlist.sql,038_validate_trustee_shortlist_groups.sql,039_validate_publication_promotion_dispositions.sql,040_validate_multi_call_foundation.sql,041_validate_publication_status_metrics.sql,043_validate_pending_publication_review_queue.sql,044_validate_call_navigation_preferences.sql,045_validate_call_navigation_preference_insert.sql') {
    throw 'The isolated test requires validators 001 through 045, with compatibility validation last.'
}
...
try {
    ...
    if (($firstRun -join "`n") -notmatch 'Applied 45 migration\(s\)\.') {
