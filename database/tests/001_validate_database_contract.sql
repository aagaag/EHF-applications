...
IF (SELECT COUNT_BIG(*) FROM dbo.SchemaMigration) <> 29
    THROW 51103, 'Exactly twenty-nine migrations must be recorded.', 1;
IF EXISTS
(
    SELECT 1
...
WHERE MigrationCount = 29 AND CurrentVersion = 29
)
    THROW 51105, 'SchemaVersion does not report version 29.', 1;
