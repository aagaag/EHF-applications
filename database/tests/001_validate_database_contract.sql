...
IF (SELECT COUNT_BIG(*) FROM dbo.SchemaMigration) <> 28
    THROW 51103, 'Exactly twenty-eight migrations must be recorded.', 1;
IF EXISTS
(
    SELECT 1
...
WHERE MigrationCount = 28 AND CurrentVersion = 28
)
