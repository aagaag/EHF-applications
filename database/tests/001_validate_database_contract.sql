...
IF (SELECT COUNT_BIG(*) FROM dbo.SchemaMigration) <> 35
    THROW 51103, 'Exactly thirty-five migrations must be recorded.', 1;
IF EXISTS
(
    SELECT 1
...
WHERE MigrationCount = 35 AND CurrentVersion = 35
)
    THROW 51105, 'SchemaVersion does not report version 35.', 1;
