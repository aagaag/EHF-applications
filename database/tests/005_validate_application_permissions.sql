...
IF OBJECT_ID(N'dbo.RecordInternalReviewArtifactFailure', N'P') IS NULL
    THROW 51527, 'The internal review-artifact failure-audit procedure is missing.', 1;
...
INSERT @ApprovedProcedures VALUES
    ...
    (N'CreateSyntheticApplicantWorkspace'), (N'GetApplicantSessionV19'),
    (N'GetApplicantProjection'), (N'GetApplicantSectionDraft'),
    (N'GetApplicantSectionDraftV17'),
