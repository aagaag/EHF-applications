...
IF OBJECT_DEFINITION(OBJECT_ID(N'dbo.GetInternalApplicantMetricDetail', N'P')) NOT LIKE N'%JournalTwoYearMeanCitedness%'
    THROW 53401, 'Applicant metric detail does not expose OpenAlex journal citedness.', 1;
