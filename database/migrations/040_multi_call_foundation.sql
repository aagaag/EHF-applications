...
ALTER TABLE dbo.FellowshipCall ADD
    CONSTRAINT DF_FellowshipCall_PublicSlug DEFAULT (LOWER(CONVERT(varchar(36), NEWID()))) FOR PublicSlug,
    CONSTRAINT DF_FellowshipCall_CompactTitle DEFAULT N''Untitled fellowship call'' FOR CompactTitle,
    CONSTRAINT DF_FellowshipCall_ApplicantReviewStatus DEFAULT ''DISABLED'' FOR ApplicantReviewStatus,
    CONSTRAINT DF_FellowshipCall_InternalSelectionStatus DEFAULT ''DISABLED'' FOR InternalSelectionStatus,
    CONSTRAINT DF_FellowshipCall_InvitationsEnabled DEFAULT 0 FOR InvitationsEnabled,
    CONSTRAINT DF_FellowshipCall_AnalysisProfileCode DEFAULT ''ehf-standard-v1'' FOR AnalysisProfileCode;
ALTER TABLE dbo.FellowshipCall ADD
