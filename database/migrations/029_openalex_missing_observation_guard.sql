...
BEGIN
    ...
    OUTER APPLY (
        SELECT
            CASE
                WHEN COUNT(CASE WHEN latest.CitationStatus=''OBSERVED'' THEN 1 END)=0
                    THEN NULL
                ELSE SUM(CASE WHEN latest.CitationStatus=''OBSERVED'' THEN latest.CitationCount ELSE CONVERT(bigint,0) END)
