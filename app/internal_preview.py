...
def _report_table(records: tuple[PreviewApplicantMetric, ...], shortlist: ShortlistState) -> str:
    ...
    return (
        ...
        '</div><div class="report-summary" data-report-summary><nav class="report-document-actions" aria-label="Applicant documents">'
        ...
        '</nav></div>'
        '<p class="report-document-status" data-report-artifact-status role="status" aria-live="polite"></p>'
